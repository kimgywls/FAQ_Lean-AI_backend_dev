    ...
    def create(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                logger.debug("Public instance created: %s", public_instance)
                return Response(
                    {
                        "status": "success",
                ...
                logger.error("Error while creating public instance: %s", str(e))
                return Response(
                    {"status": "error", "message": "공공기관 생성 중 오류가 발생했습니다."},
                    status=500,
                )
        else:
