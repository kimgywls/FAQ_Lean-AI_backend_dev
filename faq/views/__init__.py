...
from .payment_views import CustomerUIDView, BillingKeyRegisterView, BillingKeyChangeView, PaymentHistoryView, CardInfoView, BillingKeyDeleteView, PaymentProcessView